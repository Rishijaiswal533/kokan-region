<?php
// Define dashboard data for Ratnagiri district.
$dashboardData = [
    'totalRecords'     => '881',
    'detectionRate'    => '81%',
    'yoyChange'        => '+3.28%',
...
function getPoliceStationsData()
{
    try {
        ...
        // SQL query filtered for Ratnagiri district
...
<head>
    ...
    <title>Ratnagiri Police Stations Dashboard & Map</title>
    ...
    <style>
      .dashboard-grid {
        ...
        #map-container {
            ...
            box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);
            overflow: hidden;
            margin-top: 2rem; /* Spacing between dashboard and map */
        }
...
<body class="p-4 sm:p-8">
    <div id="main-container">
        <div class="max-w-4xl mx-auto">
            <h1 class="text-3xl sm:text-4xl font-bold mb-6 sm:mb-8 text-slate-800 text-center">Ratnagiri District Crime Records Dashboard</h1>
            <div class="dashboard-grid">
                <div class="card blue-border">
                    ...
                    <div class="card-description">All records processed in Ratnagiri</div>
                </div>
