<?php
// Define dashboard data for Palghar district.
...
function getPoliceStationsData()
{
    try {
        ...
        // SQL query to fetch police station data, filtered for Palghar district only
...
<head>
    ...
    <title>Palghar Police Stations Map</title>
...
<body class="p-4 sm:p-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl sm:text-4xl font-bold mb-6 sm:mb-8 text-slate-800 text-center">Palghar District Crime Records</h1>
        <div class="dashboard-grid">
            <div class="card blue-border">
                ...
                <div class="card-description">All records processed in Palghar</div>
            </div>
    ...
    <div id="dashboard-container">
        <h2 style="font-size: 1.5rem; font-weight: 600; color: #1f2937; margin-bottom: 1rem;">Palghar District Police Stations Map</h2>
    ...
    window.onload = function() {
        ...
        // Calculate the average center to dynamically position the map
        let totalLat = 0;
        let totalLng = 0;
