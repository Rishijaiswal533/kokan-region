<?php
// Define dashboard data for Thane Rural district.
$dashboardData = [
    'totalRecords'     => '1402',
    'detectionRate'    => '84%',
    'yoyChange'        => '+5.90%',
...
function getPoliceStationsData()
{
    try {
        ...
        // SQL query to fetch police station data, filtered for Thane Rural district only
...
<head>
    ...
    <title>Thane Rural Police Stations Map</title>
...
<body class="p-4 sm:p-8">
    ...
    <div id="dashboard-container">
        <h2 style="font-size: 1.5rem; font-weight: 600; color: #1f2937; margin-bottom: 1rem;">Thane Rural District Police Stations Map</h2>
